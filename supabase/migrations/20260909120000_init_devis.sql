...
create table dv_ai_estimates (
  ...
  lead_id bigint not null references dv_leads(id) on delete cascade,
  created_at timestamptz not null default now(),
  price_min_ht numeric(10,2) not null,
  price_max_ht numeric(10,2) not null,
...
begin
  insert into dv_leads (
    ...
    dv_default_artisan_id(), p_prenom, p_telephone, p_email, p_code_postal,
...
-- ——— Seed ———
insert into dv_artisans (public_id, created_at, email, display_name, metier, auth_user_id) values
  ('art_demo_01', '2026-03-01 09:00:00+00', 'vous@atelier.fr', 'Atelier Lyon', 'Électricité', 'fa95bbd6-d451-41ed-b5bb-713a3b1045e8');
...
insert into dv_photos (lead_id, sort_order, created_at, analyzed_at, titre, filename, mime_type, size_bytes, storage_path) values
  (1, 1, '2026-09-09 16:12:20+00', '2026-09-09 16:14:00+00', 'Tableau électrique — entrée', 'tableau.jpg', 'image/jpeg', 2516582, 'placeholder:ph-navy'),
  (1, 2, '2026-09-09 16:12:21+00', '2026-09-09 16:14:00+00', 'Cuisine — arrivées existantes', 'cuisine.jpg', 'image/jpeg', 1887436, 'placeholder:ph-clay'),
  (1, 3, '2026-09-09 16:12:22+00', '2026-09-09 16:14:00+00', 'Séjour — plafonnier', 'sejour.jpg', 'image/jpeg', 2202009, 'placeholder:ph-sage'),
  (1, 4, '2026-09-09 16:12:23+00', '2026-09-09 16:14:00+00', 'Dégagement — gaine apparente', 'degagement.jpg', 'image/jpeg', 1677721, 'placeholder:ph-slate');
...
grant execute on function dv_submit_lead(text, text, text, text, numeric, text, text, text, text[], text) to anon, authenticated;
